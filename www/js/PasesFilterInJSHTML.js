...
function actualizarPases(transaction, results) {
    ...
    for (i = 0; i < results.rows.length; i++) {
        ...
        listholder.innerHTML += "<table data-role='table' id='movie-table' data-filter='true'" +
        "data-input='#filterTable-input' data-mode='columntoggle' class='ui-responsive'><thead><tr>" +
        "<thead><th data-priority='1'>Fecha</th>"+
        "<th data-priority='persist'>Ficha</th>"+
        "<th data-priority='2'>Actividad</th>"+
        "<th data-priority='3'>Coche</th>"+
        "<th data-priority='3'>Destino</th>"+
        "<th data-priority='3'>Material</th>"+
        "<th data-priority='6'>Combust.</th>"+
        "<th data-priority='4'>Km.</th>"+
        "<th data-priority='4'>HoraSalida</th>"+
        "<tr></thead<tbody><th>" + row.fecha + "</th><td>" + row.ficha + "</td><td>" + row.actividad + "</td><td>" + row.vehiculo 
