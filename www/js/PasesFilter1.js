...
function actualizarPases1(transaction, results) {
    //initialise the listitems variable
    var listitems = "";
    //get the pases list holder ul
    var listholder = document.getElementById("listaPasesHolder1");
...
function salidaPases1() {
    ...
    if (mydb) {
        ...
        mydb.transaction(function (t) {
            t.executeSql("SELECT * FROM pases", [], actualizarPases1);
        });
    } else {
